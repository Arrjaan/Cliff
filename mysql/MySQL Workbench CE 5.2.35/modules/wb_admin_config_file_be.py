...
class WbAdminConfigFileBE:
    ...
    def __init__(self, server_profile, ctrl_be):
      ...
      self.possible_options = self.transform_opts_for(self.ctrl_be.get_server_version(), server_profile.target_os)
        ...
        for (grpname, grpcont) in tabcont:
          ...
          for opt in grpcont:
            ...
            if value:
              ...
              print "Option", opt['name'], " skipped because of missing value"
