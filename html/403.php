...
<body>
	<div id="container">
		...
		<div id="content">
			<div class="top_long"><h2>De toegang tot deze pagina is geweigd.</h2></div>
			<div class="middle_long">
				Het is niet toegestaan deze pagina te bezoeken.<br />
				<br />
				<a href="/">Klik hier</a> om naar de hoofdpagina te gaan.<br />
			</div>
